...
def main():
    ...
    parser = argparse.ArgumentParser(description='Calculate circuit sizes and save to a CSV file.')
    parser.add_argument('folder', type=str, help='Path to the folder containing circuit files.')
