...
def table_4_finalizer(
    ...
    """
    Finalizes statistics collected during "Table 4. Simplification statistics for various
    classes of circuits in the BENCH basis." described in the README.
